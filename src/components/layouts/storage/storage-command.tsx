...
function renderMenuIcon(IconComponent: any) {
  // Handles both Lucide and custom icons
  return IconComponent ? (
    <span className="flex h-4 w-4 items-center justify-center">
      <IconComponent className="h-4 w-4 opacity-60" aria-hidden="true" />
    </span>
  ) : null;
}

export default function StorageCommand({ className }: Props) {
